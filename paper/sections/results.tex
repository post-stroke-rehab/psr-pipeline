...
\begin{table}[!htbp]
  \centering
  \small
  \caption{Held-out test performance for the three direct model families. Subset accuracy is the multilabel exact match ratio. Bold numbers mark the best score in each column within the baseline comparison.}
