...
class CNN_Nano(nn.Module):
    def __init__(self, in_channels: int = 768, num_classes: int = 5,
                 ...
                 pool: int = 8, fc1: int = 64, dropout: float = 0.2):
        super().__init__()
...
class CNN_Micro(nn.Module):
    def __init__(self, in_channels: int = 768, num_classes: int = 5,
                 ...
                 pool: int = 8, fc1: int = 96, dropout: float = 0.2):
        super().__init__()
        self.proj = nn.Conv1d(in_channels, proj_ch, kernel_size=1)
        self.bn0 = nn.BatchNorm1d(proj_ch)
        self.conv1 = nn.Conv1d(proj_ch, conv1_ch, kernel_size=conv1_k, padding=conv1_k // 2)
...
class CNN_Base(nn.Module):
    def __init__(self, in_channels: int = 768, num_classes: int = 5,
                 ...
                 pool: int = 4, fc1: int = 128, dropout: float = 0.3):
        super().__init__()
        self.proj = nn.Conv1d(in_channels, proj_ch, kernel_size=1)
        self.bn0 = nn.BatchNorm1d(proj_ch)
        self.conv1 = nn.Conv1d(proj_ch, conv1_ch, kernel_size=conv1_k, padding=conv1_k // 2)
...
class CNN_Large(nn.Module):
    def __init__(self, in_channels: int = 768, num_classes: int = 5,
                 ...
                 pool: int = 4, fc1: int = 192, dropout: float = 0.3):
        super().__init__()
        self.proj = nn.Conv1d(in_channels, proj_ch, kernel_size=1)
        self.bn0 = nn.BatchNorm1d(proj_ch)
        self.conv1 = nn.Conv1d(proj_ch, conv1_ch, kernel_size=conv1_k, padding=conv1_k // 2)
...
class CNN_XLarge(nn.Module):
    def __init__(self, in_channels: int = 768, num_classes: int = 5,
                 ...
                 pool: int = 2, fc1: int = 256, dropout: float = 0.4):
        super().__init__()
        self.proj = nn.Conv1d(in_channels, proj_ch, kernel_size=1)
        self.bn0 = nn.BatchNorm1d(proj_ch)
        self.conv1 = nn.Conv1d(proj_ch, conv1_ch, kernel_size=conv1_k, padding=conv1_k // 2)
